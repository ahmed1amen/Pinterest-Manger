...
{
    public class DebugLogger : IPinLogger

    {
        private readonly LogLevel _logLevel;
        private bool _OutInFile = false;
        ...
        public DebugLogger(LogLevel loglevel, bool OutInFile, string path)
        {
            _logLevel = loglevel;
            _LogPath = path;
            _OutInFile = OutInFile;
        }
        ...
        private void Write(string message)
        {
            ...
            else { Console.WriteLine($"{DateTime.Now.ToString()}:\t{message}"); }
            ...
            else { System.Diagnostics.Debug.WriteLine($"{DateTime.Now.ToString()}:\t{message}"); }
